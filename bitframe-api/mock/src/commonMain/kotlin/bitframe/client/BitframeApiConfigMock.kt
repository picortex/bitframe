...
interface BitframeApiConfigMock : BitframeApiConfig, ServiceConfigMock {
    companion object {
        @JvmField
        ...
        ): BitframeApiConfigMock = object : BitframeApiConfigMock, ServiceConfigMock by ServiceConfigMock(appId, cache, session, daoFactory, bus, logger, mailer, json, scope) {}
        ...
        fun create(
            ...
            json: Json = DEFAULT_JSON,
            scope: CoroutineScope = DEFAULT_SCOPE
        ): BitframeApiConfigMock = invoke(appId, cache, session, daoFactory, bus, logger, mailer, json, scope)
    }
}