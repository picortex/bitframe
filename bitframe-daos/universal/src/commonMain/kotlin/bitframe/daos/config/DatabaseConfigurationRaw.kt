...
@Serializable
data class DatabaseConfigurationRaw(
    val instance: String?,
...
) : DatabaseConfigurationRawMongo, DatabaseConfigurationRawMock {
    companion object {
        @JvmStatic
        @JvmName("from")
        operator fun invoke(fs: FileSystem, appDir: String?, appConf: String?): DatabaseConfigurationRaw {
