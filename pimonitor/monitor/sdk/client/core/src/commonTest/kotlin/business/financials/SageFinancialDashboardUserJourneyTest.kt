...
import pimonitor.client.business.financials.BusinessFinancialsViewModel
...
class SageFinancialDashboardUserJourneyTest {
    ...
    private val vm get() = scope.businessFinancials.viewModel as BusinessFinancialsViewModel
