...
//
//internal class OldPiCortexDashboardParser(val mapper: Mapper) {
...
//        title = "Products sold", description = "Products sold this month", datasets = parseBarChartEntriesOf(
//            type = PRODUCTS_SOLD, from = json
//        )
//    )
//
//    fun parseJobsPerClientChart(json: String) = BarChart(
//        title = "Jobs per client", description = "Jobs fulfilled in the last month", datasets = parseBarChartEntriesOf(
//            type = JOBS_PER_CLIENT, from = json
//        )
//    )
//
//    fun parseHoursPerEmployee(json: String) = BarChart(
//        title = "Hours per employee", description = "Hours worked in the last month", datasets = parseBarChartEntriesOf(
//            type = HOURS_WORKED_PER_EMPLOYEE, from = json
//        )
//    )
//
//    fun parseTechnicalDashboard(json: String): OperationalDashboard {
//        val board = OperationalDashboard(charts = emptyList())
//        return board.copy(
